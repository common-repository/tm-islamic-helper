...
class TMPRAY_HijriCalendar{
    ...
    public function hijriToMiladi($miladiDay, $miladiMonth, $miladiYear)
    {
        $d = $miladiDay;
        $m = $miladiMonth;
        $y = $miladiYear;
    ...
    public function tmpray_get_hijri_date($day, $month, $year){

        $today_info = $this->dateInfo($day, $month, $year);
        $hijri_today_date = $this->hijriDays[$today_info['hijriWeekday']].', '.$today_info['hijriDay'].' '.$this->hijriMonths[$today_info['hijriMonth']].' '.$today_info['hijriYear'].' AH';

        return $hijri_today_date;
